...
The `ai-devsecops-framework` framework follows semantic versioning. The current major version receives security updates.
...
- **Preferred channel:** open a GitHub Security Advisory at https://github.com/sotille/ai-devsecops-framework/security/advisories/new
- **Alternative:** email `fsotille@gmail.com` with subject prefix `[SECURITY] ai-devsecops-framework`
